    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do //parsing menu option
            {
                ...
                switch (option)
                {
                    case 1: //konvertování do binární soustavy
                        ...
                        OutObj =  binary.Convert(userInputDecimal, 2);
                    ...
                    case 2: //konvertování do osmičkové soustavy
                        ...
                        OutObj = octa.Convert(userInputDecimal, 8);
                        Console.WriteLine($"Input: {userInputDecimal}", Color.Orange);
                        Console.Write("Output: ");
                    ...
                    case 3: //konvertování do hexa soustavy
                        ...
                        OutObj = hexa.Convert(userInputDecimal, 16);
                        Console.WriteLine($"Input: {userInputDecimal}", Color.Orange);
                        Console.Write("Output: ");
            ...
            if (info.Key == ConsoleKey.T)
            {
                ...
                if (option == 1)
                {
                    string returnBin = convertToBin(userInputDecimal);
                    if (returnBin == OutObj)
                    {
                        Console.WriteLine("TEST PASSED!", Color.Green);
                    }
                    else
                    {
                ...
                if (option == 2)
                {
                    string returnBin = convertToOct(userInputDecimal);
                    if (returnBin == OutObj)
                    {
                        Console.WriteLine("TEST PASSED!", Color.Green);
                    }
                ...
                if (option == 3)
                {
                    string returnBin = convertToHex(userInputDecimal);
                    if (returnBin == OutObj)
                    {
                        Console.WriteLine("TEST PASSED!", Color.Green);
                    }
